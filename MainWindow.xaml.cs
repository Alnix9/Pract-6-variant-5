...
namespace Генеральский_практическая_6
{
    public partial class MainWindow : Window
    {
        ...
        {
            MessageBox.Show("5.(6 практ) Использовать класс Triangle (треугольник) с полями-сторонами. " +
                "Разработать\r\nоперацию для определения возможности существования треугольника с заданными \r\nсторонами true/false. " +
                "Разработать операции для увеличения/уменьшения сторон на \r\n1.");
        }
